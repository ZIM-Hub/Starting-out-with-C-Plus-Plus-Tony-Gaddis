...
Name of this C++ program [Lowest Score Drop]
...
Brief Description of this program. calculates your lowest test score
...
int ifLowest(int num1, int num2, int num3, int num4, int num5);
...
//Definition of getscore function
void getScore(int &num)
{
...
/*
 ...
 lowest using a if statmenent to find the lowest number.
 */
int ifLowest(int num1,int num2,int num3,int num4,int num5)
{
    int lowest{};
